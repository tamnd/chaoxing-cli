...
Most of these come down to network reality or how chaoxing serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

chaoxing rate-limits like any public site. cx already paces
...
Where a surface is gated, cx reads a cookie or token you supply
...
`cx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cx actually did
