...
// HTTP behaviour is covered in chaoxing_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "chaoxing://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("chaoxing", "about")
	if err != nil || got.String() != "chaoxing://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want chaoxing://page/about", got.String(), err)
	}
}
